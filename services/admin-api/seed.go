...
func seedServices(s *Store) {
	...
	add(ServiceEntry{ID: "reg-watch", Name: "Reg-Watch / Gates", Plane: "core", Kind: "service", TItems: []string{"G1", "G2", "G8"}, BaseURL: "http://localhost:8014", URLEnv: "REG_WATCH_URL", Description: "Gate & gazette monitor; board-authorised gate flips."})
